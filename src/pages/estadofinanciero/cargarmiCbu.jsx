          ...
          <>
            <form>
              <section>
                ...
                <h3 className="mt-5">Ingresa el CBU de tu cuenta 
               <Button>
                <svg width="16" 
                height="16" 
                viewBox="0 0 16 16" 
