...
const statusNosisAtom = atomWithStorage("statusNosisAtom");
export const useStatusNosisAtom = () => {
  const [statusNosis, setStatusNosis] = useAtom(statusNosisAtom);
  return { statusNosis, setStatusNosis };
};